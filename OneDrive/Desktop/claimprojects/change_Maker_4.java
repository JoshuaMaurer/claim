 ...
 */
	...
	/**
	 * This method uses a progression of multiple if statements starting with the larger coin denomination 
	 * and ending with the smallest.
	 * The else/if statement limits the external input to only 1 - 99.
	 * @param change
	 * @return change
	 */
		public static int changeMaker(int change) {
			...
			System.out.println("This value is out of my scope to handle right now...");
		}
			return change;
